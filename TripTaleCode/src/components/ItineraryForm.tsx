        ...
        for (let day = 1; day <= duration; day++) {
            ...
            if (morningOptions.length > 0) {
                ...
                if (dayBudget + morningActivity.cost <= dailyBudget) {
                    dayActivities.push(
                        `${morningActivity.time} - ${morningActivity.name} (Rp ${morningActivity.cost.toLocaleString("id-ID")})`,
                    )
                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="semarang" disabled>
                                            Semarang (Coming Soon)
                                        </SelectItem>
                                        <SelectItem value="solo" disabled>
                                            Solo (Coming Soon)
                                        </SelectItem>
                                    </SelectContent>
                                </Select>
