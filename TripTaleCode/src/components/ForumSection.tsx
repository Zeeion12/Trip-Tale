    ...
    const [forumPosts, setForumPosts] = useState<ForumPost[]>([
        {
            ...
            content: 'Halo teman-teman! Kemarin habis keliling Jogja dan nyoba beberapa warung gudeg. Yu Djum memang enak, tapi ada hidden gem lain nih... Warung Gudeg Pawon di Gang kecil dekat Malioboro, porsinya gede dan rasanya authentic banget! Ada yang pernah coba?',
            category: 'kuliner',
            timeAgo: '2 jam lalu',
            likes: 15,
            replies: 8,
        ...
        },
        {
            ...
            content: 'Planning mau liat sunrise di Borobudur, tapi harus bangun jam 4 pagi dan bayar ekstra. Yang udah pernah, worth it ga ya? Atau mending pagi biasa aja? Share pengalaman dong!',
            category: 'review',
            timeAgo: '1 hari lalu',
            likes: 7,
            replies: 15,
        ...
        },
        {
            ...
            content: 'Ada yang punya pengalaman trip ke Jogja 3D2N dengan budget total 800rb? Termasuk akomodasi, makan, dan tiket masuk. Sharing dong itinerary dan tipsnya! Terutama untuk homestay murah yang recommended.',
            category: 'tips',
            timeAgo: '2 hari lalu',
            likes: 31,
            replies: 24,
                                        ...
                                        <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                                            <div className="flex items-center gap-4">
                                                <button
                                                    ...
                                                    className={`flex items-center gap-2 px-3 py-1 rounded-lg transition-colors ${post.isLiked
